...
<%@include file="header.jsp"%>
	...
	<div class="container bg-white margin-30-top">
		<ol class="breadcrumb" itemscope=""
			...
			<li class="active">Registrati Venditore</li>
		</ol>
		...
		<div class="row margin-30-top">
					<div  id="left-box" class="panel panel-default panel-white col-md-12 col-md-6 col-md-offset-3 bg-light">
							...
							<form action="ServletRegVenditore" method="post" id="form1">
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" name="nome" id="nome"
											placeholder="Nome Cognome o nome azienda" required>
...
<script src="scripts/validazioneVenditore.js"></script>
</body>
</html>