...
/**
 * Servlet implementation class FiltraProdottiCat
 */
@WebServlet("/FiltraProdottiCat")
public class FiltraProdottiCat extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FiltraProdottiCat() {
        super();
...
HttpSession s=request.getSession();
		...
		try {
			...
			p=pdao.doRetrieveByCategoria((String) s.getAttribute("categoria"));
